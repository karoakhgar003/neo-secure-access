-- Update assign_credentials_to_order_item function to log success for non-TOTP credentials
  ...
  IF v_product_requires_credentials THEN
    ...
    IF v_credential_id IS NOT NULL THEN
      ...
      IF v_current_seats < v_max_seats THEN
        ...
        VALUES (v_credential_id, NEW.id, v_user_id, CASE WHEN v_totp_secret IS NOT NULL THEN 'unclaimed' ELSE 'success' END)
